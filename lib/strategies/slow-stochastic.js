...
class SlowStochastic {
     ...
     * for use in conjunction with other indicators in the future
     * @return {Integer}
     */
    signal() {
        const buySignal = 1
        ...
        if (currentK > currentD && currentK < 20 && currentD < 20) {
            return buySignal
        } else if(currentK < currentD && currentK > 80 && currentD > 80) {
            return sellSignal
        } else {
            return noSignal
        }
