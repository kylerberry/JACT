...
class PortfolioManager {
     ...
     */
    getFundingAmount() {
        let amount = this.account.available
        return amount > config.get('max_funds') ? config.get('max_funds') : amount
    }
}

module.exports = account => manager instanceof PortfolioManager ? manager : new PortfolioManager(account)