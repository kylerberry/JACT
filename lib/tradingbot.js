...
// @todo only trade on 2 day bullish trends
// @todo add 10% stop loss protection
// @todo create lifecycle hooks
// @todo be able to make bot have different purchasing strategies
// ie: stagger buy/sell vs stack buys for averaging

/**
 * creates a new trade implementation
 */

const { gdax, websocket, CAREFUL_PRODUCTION_GDAX } = require('./gdax')
    ...
    getData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!self.historicData.length) {
                CAREFUL_PRODUCTION_GDAX.getProductHistoricRates(self.product, {
